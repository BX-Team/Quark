...
/**
 * Log adapter for Velocity plugins using SLF4J loggers.
 */
public class VelocityLogAdapter implements LogAdapter {
    private final Logger logger;

    /**
     * Creates a new Velocity log adapter that logs to a SLF4J logger.
     *
     * @param logger the SLF4J logger to wrap (typically from Velocity plugin)
     */
