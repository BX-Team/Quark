package org.bxteam.quark.velocity.test;
...
@Plugin(
        id = "velocitytestplugin",
        name = "VelocityTestPlugin",
        version = "1.0.0",
        description = "A test plugin for Quark Velocity integration",
        authors = {"BX Team"}
)
public class VelocityTestPlugin {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) {
        ...
        libraryManager.loadDependency("org.apache.commons", "commons-lang3", "3.12.0");
    }
